...
void noRemovePointOfInterest(void){
    printf("+---------------------------------------------------------------+\n");
    printf("|       O aluno ainda não tem Pontos de Interesse definidos!    |\n");
    printf("|                Não existem Pontos de Interesse                |\n");
    printf("|                  passiveis de ser removidos                   |\n");
    printf("+---------------------------------------------------------------+\n");
    ConsolePause(3.5);
}

void noRemovePointOfInterestHot(void){
    printf("+---------------------------------------------------------------+\n");
    printf("|    O aluno ainda não tem um Ponto de Interesse Hot definido!  |\n");
    printf("|        É necessário marcar um ponto de interesse como Hot     |\n");
    printf("|                     para o poder remover!                     |\n");
    printf("+---------------------------------------------------------------+\n");
    ConsolePause(3.5);
}